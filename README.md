...
Исходный код Atlas App Window распространяется по [Apache License 2.0](LICENSE). Коммерческое и
некоммерческое использование, изменение и распространение разрешены на условиях этой лицензии.
Условия сторонней ADB-библиотеки приведены в [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).
Правила подготовки изменений описаны в [CONTRIBUTING.md](CONTRIBUTING.md), а приватного сообщения
